    ...
    <section className="flex flex-col lg:flex-row items-stretch py-12 lg:py-0 max-w-[1400px] mx-auto bg-black/90 relative z-30">
      ...
      <div className="lg:w-1/2 w-full px-8 md:px-12 lg:px-16 xl:px-20 flex flex-col justify-center">
        ...
        <ScrollBasedAnimation direction="left" offset={50} delay={0.1}>
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 font-light" dangerouslySetInnerHTML={{ __html: t("aboutParagraph1").replace("CreativeDigital", '<span class="font-medium text-accent">CreativeDigital</span>') }}>
          </p>
        </ScrollBasedAnimation>

        <ScrollBasedAnimation direction="left" offset={50} delay={0.2}>
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 font-light" dangerouslySetInnerHTML={{ __html: t("aboutParagraph2").replace("200+", '<span class="font-medium text-accent">200+</span>') }}>
          </p>
        </ScrollBasedAnimation>

        <ScrollBasedAnimation direction="left" offset={50} delay={0.3}>
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light" dangerouslySetInnerHTML={{ __html: t("aboutParagraph3").replace("impactful strategies", '<span class="font-medium text-black">impactful strategies</span>') }}>
          </p>
        </ScrollBasedAnimation>
      </div>
